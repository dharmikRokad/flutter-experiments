...
import 'package:flutter_experiments/widgets/snake.dart';
import 'package:sensors_plus/sensors_plus.dart';

class SensorsPlusScreen extends StatefulWidget {
  const SensorsPlusScreen({super.key, this.title});
                ...
                TableRow(
                  children: [
                    Padding(
                      ...
                      child: const Text('UserAccelerometer'),
                    ),
